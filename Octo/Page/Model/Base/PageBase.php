...
trait PageBase
{
    ...
    *
    * @uses \Octo\Page\Store\PageVersionStore::getById()
    * @uses \Octo\Page\Model\PageVersion
    * @return \Octo\Page\Model\PageVersion
    */
    public function getCurrentVersion()
    {
        ...
        return Factory::getStore('PageVersion', 'Octo\Page')->getById($key);
    }
    ...
    */
    public function setCurrentVersion($value)
    {
        ...
        if ($value instanceof \Octo\Page\Model\PageVersion) {
    ...
    *
    * @param $value \Octo\Page\Model\PageVersion
    */
    public function setCurrentVersionObject(\Octo\Page\Model\PageVersion $value)
    {
    ...
    */
    public function setParentObject(\Octo\Page\Model\Page $value)
    {
