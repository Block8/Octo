...
'fk_page_version_page' => array('columns' => 'page_id'),
'fk_page_version_user' => array('columns' => 'user_id'),
'fk_page_version_content_item' => array('columns' => 'content_item_id'),
'image_id' => array('columns' => 'image_id'),
);
...
'fk_page_version_content_item' => array(
...
$cacheKey   = 'Cache.ContentItem.' . $key;
$rtn        = $this->cache->get($cacheKey, null);

if (empty($rtn)) {
$rtn    = Factory::getStore('ContentItem', 'Octo')->getById($key);
...
{
return Factory::getStore('PageVersion', 'Octo')->getByPrimaryKey($value, $useConnection);
}


public static function getById($value, $useConnection = 'read')
{
return Factory::getStore('PageVersion', 'Octo')->getById($value, $useConnection);
}

public static function getByPageId($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('PageVersion', 'Octo')->getByPageId($value, $limit, $useConnection);
}

public static function getByContentItemId($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('PageVersion', 'Octo')->getByContentItemId($value, $limit, $useConnection);
}

public static function getByUserId($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('PageVersion', 'Octo')->getByUserId($value, $limit, $useConnection);
}

public static function getByImageId($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('PageVersion', 'Octo')->getByImageId($value, $limit, $useConnection);
}
