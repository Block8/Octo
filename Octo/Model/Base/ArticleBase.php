...
'slug' => array('unique' => true, 'columns' => 'slug'),
'user_id' => array('columns' => 'user_id'),
'category_id' => array('columns' => 'category_id'),
'author_id' => array('columns' => 'author_id'),
'content_item_id' => array('columns' => 'content_item_id'),
);
...
{
return Factory::getStore('Article', 'Octo')->getById($value, $useConnection);
}

public static function getByUserId($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('Article', 'Octo')->getByUserId($value, $limit, $useConnection);
}

public static function getByCategoryId($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('Article', 'Octo')->getByCategoryId($value, $limit, $useConnection);
}

public static function getByAuthorId($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('Article', 'Octo')->getByAuthorId($value, $limit, $useConnection);
}

public static function getByContentItemId($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('Article', 'Octo')->getByContentItemId($value, $limit, $useConnection);
}

public static function getBySlug($value, $useConnection = 'read')
{
return Factory::getStore('Article', 'Octo')->getBySlug($value, $useConnection);
}
