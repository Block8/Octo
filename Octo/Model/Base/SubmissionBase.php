...
'form_id' => array('columns' => 'form_id'),
'contact_id' => array('columns' => 'contact_id'),
);
...
$cacheKey   = 'Cache.Form.' . $key;
$rtn        = $this->cache->get($cacheKey, null);

if (empty($rtn)) {
$rtn    = Factory::getStore('Form', 'Octo')->getById($key);
...
$cacheKey   = 'Cache.Contact.' . $key;
$rtn        = $this->cache->get($cacheKey, null);

if (empty($rtn)) {
$rtn    = Factory::getStore('Contact', 'Octo')->getById($key);
$this->cache->set($cacheKey, $rtn);
}
...
{
return Factory::getStore('Submission', 'Octo')->getById($value, $useConnection);
}

public static function getByFormId($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('Submission', 'Octo')->getByFormId($value, $limit, $useConnection);
}

public static function getByContactId($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('Submission', 'Octo')->getByContactId($value, $limit, $useConnection);
}
