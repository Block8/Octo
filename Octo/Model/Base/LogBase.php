...
{
return Factory::getStore('Log', 'Octo')->getById($value, $useConnection);
}

public static function getByType($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('Log', 'Octo')->getByType($value, $limit, $useConnection);
}

public static function getByScope($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('Log', 'Octo')->getByScope($value, $limit, $useConnection);
}

public static function getByUserId($value, $limit = null, $useConnection = 'read')
{
return Factory::getStore('Log', 'Octo')->getByUserId($value, $limit, $useConnection);
}
