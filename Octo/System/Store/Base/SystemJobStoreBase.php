...
/**
 * SystemJob base store for table: system_job
 */
...
use Octo\Store;
use Octo\System\Model\SystemJob;

/**
 * SystemJob Base Store
 */
trait SystemJobStoreBase
{
    protected function init()
    {
        $this->tableName = 'system_job';
        $this->modelName = '\Octo\System\Model\SystemJob';
        $this->primaryKey = 'id';
    }
    /**
    * @param $value
    ...
    */
     ...
     * @return int
     */
    public function getTotalForRunDate($value, $options = [], $useConnection = 'read')
    {
        if (is_null($value)) {
            throw new StoreException('Value passed to ' . __FUNCTION__ . ' cannot be null.');
        }
        ...
        try {
            ...
            throw new StoreException('Could not get count of SystemJob by RunDate', 0, $ex);
        }
    }
