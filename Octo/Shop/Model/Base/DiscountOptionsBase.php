...
/**
 * DiscountOptions base model for table: discount_options
 */
...
/**
 * DiscountOptions Base Model
 */
trait DiscountOptionsBase
{
    protected function init()
    {
        $this->tableName = 'discount_options';
        $this->modelName = 'DiscountOptions';
    ...
    */
    ...
    /**
    * Get the Discount model for this DiscountOptions by Id.
    *
