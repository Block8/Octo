...
trait LineItemStoreBase
{
    ...
    */
    public function getById($value, $useConnection = 'read')
    {
        ...
        $query->select('*')->from('line_item')->limit(1);
        $query->where('`id` = :id');
        $query->bind(':id', $value);
        ...
        try {
            ...
            throw new StoreException('Could not get LineItem by Id', 0, $ex);
        }
    }
    ...
    public function getTotalForInvoiceId($value, $options = [], $useConnection = 'read')
    {
        ...
        $query = new Query($this->getNamespace('LineItem').'\Model\LineItem', $useConnection);
        $query->from('line_item')->where('`invoice_id` = :invoice_id');
        ...
        try {
            ...
            throw new StoreException('Could not get count of LineItem by InvoiceId', 0, $ex);
        }
    }
    ...
    public function getByInvoiceId($value, $options = [], $useConnection = 'read')
    {
        ...
        try {
            ...
            throw new StoreException('Could not get LineItem by InvoiceId', 0, $ex);
        }
    ...
    public function getTotalForItemId($value, $options = [], $useConnection = 'read')
    {
        ...
        $query = new Query($this->getNamespace('LineItem').'\Model\LineItem', $useConnection);
        $query->from('line_item')->where('`item_id` = :item_id');
        ...
        try {
            ...
            throw new StoreException('Could not get count of LineItem by ItemId', 0, $ex);
        }
    }
    ...
    public function getByItemId($value, $options = [], $useConnection = 'read')
    {
        ...
        try {
            ...
            throw new StoreException('Could not get LineItem by ItemId', 0, $ex);
        }
